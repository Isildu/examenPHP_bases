...
INSERT INTO 'seccions' ('sec_id','sec_nom') VALUES (1,'Ciència'),
 (2,'Cultura'),
 (3,'Educació'),
 (4,'Esports'),
 (5,'Oci');
INSERT INTO 'noticies' ('not_id','not_titular','not_cos','not_data','sec_id') VALUES (1,'Nova exposició d''art','Aquest és el contingut de la notícia sobre nova exposició d''art.','2025-03-20',2),
