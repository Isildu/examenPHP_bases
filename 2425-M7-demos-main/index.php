...
<body class="bg-gray-900 flex flex-col items-center justify-center min-h-screen p-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 w-full max-w-2xl">
        ...
        <a href="zzz(proves)/index.php" class="bg-blue-600 text-white py-4 px-6 rounded-lg shadow-md text-center hover:bg-blue-700 text-xl w-full min-h-16 flex items-center justify-center">PROVES</a>
    </div>
</body>
</html>
